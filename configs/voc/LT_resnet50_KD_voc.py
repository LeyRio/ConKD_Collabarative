...
pretrained_model = dict(
    ...
    con_loss = dict(type = 'ConCollaLoss'))
student_model = dict(
    ...
    head2=dict(
        ...
        lamda = 10,
        logit_reg=dict(init_bias=0.05, neg_scale=5),
        freq_file='appendix/VOCdevkit/longtail2012/class_freq.pkl'
        )
# model training and testing settings
train_cfg = dict()
test_cfg = dict()
pretrained_check_dir = 'work_dirs/LT_voc_resnet50_contrastv2/epoch_8.pth'
...
log_level = 'INFO'
work_dir = './work_dirs/LT_voc_resnet50_KD'
load_from = None
resume_from = None
workflow = [('train', 1)]
