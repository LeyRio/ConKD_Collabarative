...
# maybe error
from mllt.apis.train import train_classifier_new,train_classifier_pre
import torch
...
def main():
    ...
    train_dataset_random = build_dataset(cfg.data.train_random)
    ...
    train_classifier_new(
        model, train_dataset, cfg,
        distributed=distributed, validate=args.validate, logger=logger,train_random = train_dataset_random)
